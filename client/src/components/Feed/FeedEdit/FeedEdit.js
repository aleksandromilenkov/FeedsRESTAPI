...
class FeedEdit extends Component {
  ...
  acceptPostChangeHandler = () => {
    ...
    formData.append("title", this.state.postForm.title.value);
    formData.append("image", this.state.postForm.image.value);
    formData.append("content", this.state.postForm.content.value);
    this.props.onFinishEdit(formData);
    this.setState({
      postForm: POST_FORM,
      formIsValid: false,
      imagePreview: null,
